...
import { BORROW_MOCK_TOKENS_LIST, BorrowCollateralType, COLLATERAL_TOKENS_LIST } from '../constants'
...
export const useListLoansContent = () => {
  ...
  const [collateralToken, setCollateralToken] = useState<BorrowCollateralType>(
