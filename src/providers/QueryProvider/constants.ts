import { USE_BORROW_NFTS_V2_QUERY_KEY } from '@banx/pages/BorrowPage/hooks'
...
} from '@banx/pages/LoansPage/hooks'
import { USE_LENDER_LOANS_QUERY_KEY } from '@banx/pages/OffersPage/hooks'
